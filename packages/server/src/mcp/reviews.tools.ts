...
// Shared
import { ChecklistItemSchema, ReviewDecisionEnum } from '@atlas/shared';
  ...
  server.registerTool(
    'submit_review',
    {
      ...
      inputSchema: z.object({
        ...
        checklistUpdates: z.array(ChecklistItemSchema).optional().describe('Update checklist item completion status'),
      }),
    },
