...
import { RefreshCw, ExternalLink, ChevronUp, ChevronDown, Terminal, Copy, Check } from 'lucide-react';
  ...
  return (
    <Popover>
      ...
      <PopoverContent side="right" align="end" className="w-72 p-0">
        ...
        {/* Setup guide: show install/auth commands when needed */}
...
export function AgentStatusPanel({ expanded }: { expanded: boolean }) {
  ...
  // Collapsed sidebar: just show a status icon
  if (!expanded) {
    return (
