...
const GlobalPage = lazy(() =>
  import('@/pages/global/global.page').then((m) => ({ default: m.GlobalPage })),
);
const KanbanPage = lazy(() =>
  import('@/pages/kanban/kanban.page').then((m) => ({ default: m.KanbanPage })),
);
...
const RulesPage = lazy(() =>
  import('@/pages/rules/rules.page').then((m) => ({ default: m.RulesPage })),
);
...
const WelcomePage = lazy(() =>
  import('@/pages/onboarding/welcome.page').then((m) => ({ default: m.WelcomePage })),
);
